...
const checkpoints: Checkpoint[] = [
  {
    ...
    achievements: [
      "Built BI dashboard with Next.js — 25% faster decision-making",
      "Contributed to Golang backend systems",
    ],
  ...
  },
  {
    ...
    achievements: [
      "APIs for Asia Pacific — 20% satisfaction increase",
  ...
  },
  {
    ...
    achievements: [
      "Exam lockdown & remote proctoring features",
      "Led WCAG 2.2 AA compliance initiative",
    ],
    tech: ["React", "Next.js", "TypeScript", "Go"],
    lesson: "Accessibility leadership at enterprise scale.",
    current: true,
  },
];
